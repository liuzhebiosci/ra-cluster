...
exprs.f="/Users/zheliu/Desktop/R1/mechanism-level/gse15258.collapse.txt"
...
dir.create(file.path(getwd(), "gse15258"), showWarnings = FALSE)
dir.create(file.path(getwd(), "gse15258/clustering"), showWarnings = FALSE)

res.f=paste(local.dir, "gse15258", sep="")
...
title.hc.cor=paste(getwd(), "/gse15258/clustering/hc.cor", sep="")
...
title.hc.euc=paste(getwd(), "/gse15258/clustering/hc.euc", sep="")
...
title.pam.cor=paste(getwd(), "/gse15258/clustering/pam.cor", sep="")
...
title.pam.euc=paste(getwd(), "/gse15258/clustering/pam.euc", sep="")
...
write.table(cbind(top.pathways.hc.cor, pw.hc.cor.link), file="top plage mechanism pathways.txt", sep="\t", quote=F, row.names=T, col.names=T)
print("discriminative pathway analysis--done")

# save the environment image
save.image("/Users/zheliu/Desktop/R1/mechanism-level/gse15258/gse15258.Rdata")
