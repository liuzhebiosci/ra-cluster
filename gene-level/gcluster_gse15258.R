...
#    exprs.f="H:/Zhe Liu/project/gene expression data/GSE15258/top 5000 gene.txt"
# 
...
exprs.f="/Users/zheliu/Desktop/R1/gene-level/gse15258.exprs.txt"
...
title.hc.euc = paste(getwd(), "/gse15258/clustering/hc.euclidean", sep="")
...
title.pam.cor = paste(getwd(), "/gse15258/clustering/pam.pearson", sep="")
...
title.pam.euc = paste(getwd(), "/gse15258/clustering/pam.euclidean", sep="")
...
save.image(file="gse15258.Rdata")
